...
function localStorageBackup() {
    ...
    if (localStorage.templistprimaryColor) {
        document.getElementById('colorID').value = localStorage.templistprimaryColor;
        document.querySelector('html').style.setProperty('--primary-bg-color', localStorage.templistprimaryColor);
        document.querySelector('html').style.setProperty('--primary-bg-hover', localStorage.templistprimaryHoverColor);
        document.querySelector('html').style.setProperty('--primary-bg-border', localStorage.templistprimaryBorderColor);
        document.querySelector('html').style.setProperty('--primary-bg-transparentcolor', localStorage.templistprimaryTransparent);
    }

    if (localStorage.templistsecondaryColor) {
        document.getElementById('colorID2').value = localStorage.templistsecondaryColor;
        document.querySelector('html').style.setProperty('--secondary-color', localStorage.templistsecondaryColor);
        document.querySelector('html').style.setProperty('--secondary-hover', localStorage.templistsecondaryHoverColor);
        document.querySelector('html').style.setProperty('--secondary-transparent', localStorage.templistsecondaryTransparentColor);
        
    }
    
    if (localStorage.templistbgColor) {
        document.getElementById('bgID').value = localStorage.templistbgColor;
        document.querySelector('html').style.setProperty('--dark-body', localStorage.templistbgColor);
        document.querySelector('html').style.setProperty('--dark-theme', localStorage.templistthemeColor);
        document.querySelector('body').classList.add('dark-theme');
        document.querySelector('body').classList.remove('light-theme');
        $('#myonoffswitch57').prop('checked', true);
    }

    if (localStorage.templistrtl) {
        $('body').addClass('rtl');
        $('#myonoffswitch55').prop('checked', true);
    }

    if (localStorage.templistdark) {
        $('body').addClass('dark-theme');
        $('body').removeClass('light-theme');
        $('#myonoffswitch57').prop('checked', true);
    }

	if (localStorage.templistlight) {
...
function changePrimaryColor() {
    ...
    localStorage.setItem('templistprimaryColor', userColor);
    // to store value as opacity 0.95 we use 95
    localStorage.setItem('templistprimaryHoverColor', userColor + 95);
    localStorage.setItem('templistprimaryBorderColor', userColor);
    localStorage.setItem('templistprimaryTransparent', userColor + 20);
    names();
}
...
function changeSecondaryColor() {
    ...
    localStorage.setItem('templistsecondaryColor', userColor);
    // to store value as opacity 0.95 we use 95
    localStorage.setItem('templistsecondaryHoverColor', userColor + 95);
    localStorage.setItem('templistsecondaryTransparentColor', userColor + 20);
    names();
}
...
function changeBackgroundColor() {
    ...
    localStorage.setItem('templistbgColor', userColor + 'dd');
    localStorage.setItem('templistthemeColor', userColor);
...
function names() {
    ...
    //get variable
    myVarVal = localStorage.getItem("templistprimaryColor") ||primaryColorVal;
    myVarVal1 = localStorage.getItem("templistsecondaryColor") || secondaryColorVal;
